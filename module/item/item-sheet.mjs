...
export class BluePlanetItemSheet extends foundry.appv1.sheets.ItemSheet {
  ...
  /** @override */
  async close(options={}) {
    // Let the parent handle closing without forcing extra saves
    // The auto-save functionality should have already handled any changes
    console.log(`BluePlanet Item (${this.item.type}): Sheet closing naturally...`);
